    ...
    <PageTransition id="profile">
      ...
      >
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div
            className="float-bg-element absolute top-3/4 left-3/4 w-60 h-60 rounded-full bg-purple-500/10 opacity-20"
            style={{ animationDelay: "-2s" }}
          ></div>
          <div
            className="float-bg-element absolute top-1/2 left-1/6 w-20 h-20 rounded-full bg-green-500/10 opacity-20"
            style={{ animationDelay: "-3s" }}
          ></div>
          <div
            className="float-bg-element absolute top-1/3 right-1/4 w-32 h-32 rounded-full bg-red-500/10 opacity-20"
        ...
        >
          ...
          <div
            className="absolute -top-6 -right-4 w-12 h-12 bg-primary/20 rounded-full animate-bounce"
            style={{ animationDuration: "3s" }}
          ></div>
          <div
            className="absolute -bottom-2 -left-3 w-8 h-8 bg-primary/30 rounded-full animate-bounce"
        ...
        >
          <p className="hero-animate text-xl font-semibold mb-2 text-muted-foreground">
            Hello, I'm
          </p>
          <h1 className="hero-animate text-4xl md:text-5xl font-bold mb-3 transform transition-all duration-500">
            Tony Saran
          </h1>
